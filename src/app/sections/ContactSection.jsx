    ...
    <section id="contact" className="py-24 relative overflow-hidden ">
      ...
      >
        <motion.div className=" mb-16" variants={itemVariants}>
          <h2 className="text-5xl md:text-9xl font-bold mb-4 text-white">Contact Us</h2>
        </motion.div>

        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          {/* Contact Info */}
          <motion.div className="bg-white rounded-2xl shadow-xl p-8" variants={itemVariants}>
            <h3 className="text-2xl font-bold mb-6 text-[#9e0d22]">Contact Information</h3>
            ...
            <div className="space-y-8">
              <motion.div className="flex items-start" variants={itemVariants}>
                ...
                <div>
                  ...
                  <p className="text-gray-600 mb-1">+964 234 567 890</p>
                  <p className="text-gray-600">+964 987 654 321</p>
                </div>
              </motion.div>
              ...
              <motion.div className="flex items-start" variants={itemVariants}>
                ...
                <div>
                  ...
                  <p className="text-gray-600 mb-1"> info@bawabt-albargsiyah.com</p>
                  <p className="text-gray-600">support@bawabt-albargsiyah.com</p>
                </div>
              </motion.div>
          ...
          {/* Contact Form */}
          <motion.div className="bg-white rounded-2xl shadow-xl p-8" variants={itemVariants}>
            <h3 className="text-2xl font-bold mb-6 text-[#9e0d22]">Send a Message</h3>
