...
export default function SplitBanner() {
  return (
    <div className="relative w-full h-screen flex">
      {/* Drilling Half */}
      <Link href="/services/drilling" className="w-1/2 bg-[#9e0d22] flex justify-center items-center relative group">
      ...
      {/* Service Half */}
      <Link href="/services/service" className="w-1/2 relative flex justify-center items-center group">
        <Image
          src="/ser (3).webp"
          alt="Service trucks"
          layout="fill"
