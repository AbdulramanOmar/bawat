...
import { HiOutlineUserGroup, HiOutlineDocument, HiOutlineTruck, HiOutlineFire } from "react-icons/hi";
...
const steps = [
  {
    ...
    description: "Discuss goals, regulations, and project expectations.",
    icon: <HiOutlineUserGroup size={28} />,
  },
  {
    title: "Compliance Setup",
    description: "Documentation, permits, and operational clearance.",
    icon: <HiOutlineDocument size={28} />,
  },
  {
    title: "Logistics Planning",
    description: "Route optimization, schedule structuring, and risk checks.",
    icon: <HiOutlineTruck size={28} />,
  },
  {
    title: "Fuel Scheduling",
    description: "Timely deliveries coordinated with live tracking.",
  ...
  return (
    <section className="relative bg-[#0a0a0a] text-white py-40 overflow-hidden">
      <div className="max-w-6xl mx-auto px-6">
        <h2 className="text-center text-5xl font-extrabold text-white mb-24">
          How to Work With Us
        </h2>
