      ...
      <div className="grid grid-cols-1 containe">
        {certifications.map((item, index) => (
          ...
          >
            ...
            <div className="absolute top-0 right-0 z-50 rounded-lg  w-[150px] h-[150px] opacity-0 group-hover:opacity-100 bg-black/80 translate-x-10 group-hover:translate-x-0 transition-all duration-500 flex items-center justify-center">
              <Image
                src={item.image}
                alt={item.title}
                fill
