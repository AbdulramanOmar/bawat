...
const services = [
...

  {
    ...
    background: "/ser (2).jpg",
       button: "Get Supply Support →",
    description:
    ...
    >
      ...
      >
        ...
        >
          ...
          <button className="mt-4 cursor-pointer px-6 py-2 border text-white duration-300">
            <Link href="/contact">
              {service.button}
            </Link>
          </button>
